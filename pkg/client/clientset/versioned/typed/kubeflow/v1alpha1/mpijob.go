...
func (c *mPIJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MPIJob, err error) {
...
func (c *mPIJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MPIJobList, err error) {
...
func (c *mPIJobs) Create(ctx context.Context, mPIJob *v1alpha1.MPIJob, opts v1.CreateOptions) (result *v1alpha1.MPIJob, err error) {
	result = &v1alpha1.MPIJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mpijobs").
...
func (c *mPIJobs) Update(ctx context.Context, mPIJob *v1alpha1.MPIJob, opts v1.UpdateOptions) (result *v1alpha1.MPIJob, err error) {
	result = &v1alpha1.MPIJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mpijobs").
...
func (c *mPIJobs) UpdateStatus(ctx context.Context, mPIJob *v1alpha1.MPIJob, opts v1.UpdateOptions) (result *v1alpha1.MPIJob, err error) {
	result = &v1alpha1.MPIJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mpijobs").
...
func (c *mPIJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MPIJob, err error) {
	result = &v1alpha1.MPIJob{}
