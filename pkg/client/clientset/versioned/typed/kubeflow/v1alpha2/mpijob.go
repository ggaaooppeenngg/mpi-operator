...
type MPIJobInterface interface {
	Create(ctx context.Context, mPIJob *v1alpha2.MPIJob, opts v1.CreateOptions) (*v1alpha2.MPIJob, error)
	Update(ctx context.Context, mPIJob *v1alpha2.MPIJob, opts v1.UpdateOptions) (*v1alpha2.MPIJob, error)
	UpdateStatus(ctx context.Context, mPIJob *v1alpha2.MPIJob, opts v1.UpdateOptions) (*v1alpha2.MPIJob, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha2.MPIJob, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha2.MPIJobList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.MPIJob, err error)
	MPIJobExpansion
}
...
func (c *mPIJobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.MPIJob, err error) {
	result = &v1alpha2.MPIJob{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mpijobs").
		Name(name).
...
func (c *mPIJobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.MPIJobList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.MPIJobList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mpijobs").
...
func (c *mPIJobs) Create(ctx context.Context, mPIJob *v1alpha2.MPIJob, opts v1.CreateOptions) (result *v1alpha2.MPIJob, err error) {
	result = &v1alpha2.MPIJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mpijobs").
...
func (c *mPIJobs) Update(ctx context.Context, mPIJob *v1alpha2.MPIJob, opts v1.UpdateOptions) (result *v1alpha2.MPIJob, err error) {
	result = &v1alpha2.MPIJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mpijobs").
...
func (c *mPIJobs) UpdateStatus(ctx context.Context, mPIJob *v1alpha2.MPIJob, opts v1.UpdateOptions) (result *v1alpha2.MPIJob, err error) {
	result = &v1alpha2.MPIJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mpijobs").
...
func (c *mPIJobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.MPIJob, err error) {
	result = &v1alpha2.MPIJob{}
